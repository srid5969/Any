package com.sam.db1.repository;
...
public interface CompanyRepository extends JpaRepository<Company, Integer> {
	...
	@Query(value = "CALL public.insert_companynamebyid_by_sri(:companyid , :companyName)", nativeQuery = true)
	public void updataCompanyNameusingCompanyId(@Param("companyid") int companyid,
